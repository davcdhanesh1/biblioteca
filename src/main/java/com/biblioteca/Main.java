...
public class Main {
    ...
    public static void main(String[] args) throws BookNotFoundException, BookIsNotAvailable {
        ...
        Book harryPotterAndPhilosophersStoneBook = new Book("Harry potters and philosophers Stone", "J K Rowling", 1987);
        Book harryPotterAndChambersOfSecretsBook = new Book("Harry potters and chambers of secrets", "J K Rowling", 1987);
